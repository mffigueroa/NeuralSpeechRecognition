...
class ResNet_AcousticModel(nn.Module):
    def __init__(self, spectral_filter_dims, min_output_word_id, max_word_id, resnet_backbone_name=None, bottleneck_size=None):
        ...
        self.backbone = resnet_backbone(include_top=False, norm_layer=GroupNormWrapper, input_channels=input_channels, zero_init_residual=True, replace_stride_with_dilation=[False,False,False,False], remove_maxpool=True, first_conv_stride=1)
